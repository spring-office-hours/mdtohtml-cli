...
public class Converter {
    ...
    private static String convertMarkdownToBookmark(String markdown) {
        ...
        bookmark.append("<!DOCTYPE NETSCAPE-Bookmark-file-1>\n")
                ...
                .append("<DL><p>\n")
                .append(String.format("    <DT><H3 ADD_DATE=\"%s\" LAST_MODIFIED=\"%s\" PERSONAL_TOOLBAR_FOLDER=\"true\">Bookmarks Bar</H3>\n",time,time))
                .append("    <DL><p>\n")
        ...
        for (String line : lines) {
            ...
            if (categoryMatcher.find()) {
                ...
                bookmark.append("            <DT><H3 ADD_DATE=\"").append(time).append("\" LAST_MODIFIED=\"").append(time).append("\">").append(currentCategory).append("</H3>\n")
                        .append("            <DL><p>\n");
            } else if (linkMatcher.find()) {
                String linkText = linkMatcher.group(1);
                String linkHref = linkMatcher.group(2);
                bookmark.append("                <DT><A HREF=\"").append(linkHref).append("\" ADD_DATE=\"").append(time).append("\">").append(linkText).append("</A>\n");
            }
        }
